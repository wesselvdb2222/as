      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          <div className="flex shrink-0 flex-col items-center gap-3 text-center lg:w-56 lg:items-start lg:text-left">
            <p className="text-2xl font-semibold text-foreground">Excellent</p>
            <Image
            ...
            <div className="mt-4 hidden gap-2 lg:flex">
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-border text-foreground transition-colors hover:bg-white/[0.06]"
              >
          ...
          >
            {REVIEWS.map((review) => (
              <div
                key={review.name}
                className="flex w-72 shrink-0 snap-start flex-col rounded-lg border border-border bg-white/[0.04] p-6 backdrop-blur-sm"
              >
